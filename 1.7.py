...
tabela = pd.read_excel('Final/Funcional/Automacaoxl.xlsx')

for i, n_ope in enumerate(tabela["PRIMEIRO NOME"]): 
    s_ope = tabela.loc[i, "SOBRENOME"]
    nome_ope = tabela.loc[i, "NOME COMPLETO"]
    cod_olos = tabela.loc[i, "OLOS"]
    email_ope = tabela.loc[i, "E-MAIL"]
    cpf_ope = tabela.loc[i, "CPF"]
    ad_perfil = tabela.loc[i, "PERFIL MÓVEL"]
...
############################################## OLOS #####################################################
   ...
   #verifica se tem alert na poçilga da pagina do zimbra que nao deveria mais existir nessa empresa
    ...
    navegador.find_element(By.ID, 'ctl00_PageContent_TabContainer1_TabPanel1_UserName').send_keys(nome_ope)
    time.sleep(0.5)
    navegador.find_element('xpath', '//*[@id="ctl00_PageContent_TabContainer1_TabPanel1_UserLogin"]').send_keys(str(cod_olos).replace(".0",""))
    time.sleep(0.5)
    ...
    time.sleep(1)
    navegador.find_element(By.ID, 'txtNome').send_keys(nome_ope)
    time.sleep(0.5)
    navegador.find_element('xpath', '//*[@id="selNivel"]/option[16]').click()
    time.sleep(0.5)
    navegador.find_element(By.ID, 'txtCPF').send_keys(cpf_ope)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'txtLogin').send_keys(ad_perfil)
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    navegador.find_element(By.ID, 'txtEmail').send_keys(email_ope)
    time.sleep(0.5)
    navegador.find_element('xpath', '//*[@id="tabOperadores"]/li[3]/a').click()
    time.sleep(0.5)
    navegador.find_element(By.ID, 'txtRamal').send_keys(str(cod_olos).replace(".0",""))
    time.sleep(0.5)
    ...
    #Cadastro
    navegador.find_element(By.ID, 'nomeCompletoTextBox').send_keys(nome_ope)
    time.sleep(0.5)
    navegador.find_element('xpath', '//*[@id="departamentoDropDownList"]/option[63]').click()
    time.sleep(0.5)
    navegador.find_element(By.ID, 'emailTextBox').send_keys(email_ope)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'usuarioADTextBox').send_keys(ad_perfil)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'senhaUsuarioADTextBox').send_keys('Mudar@123')
    time.sleep(0.5)
    navegador.find_element(By.ID, 'loginCobmaisTextBox').send_keys(ad_perfil)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'loginOlosTextBox').send_keys(str(cod_olos).replace(".0",""))
    time.sleep(0.5)
    navegador.find_element(By.ID, 'loginTextBox').send_keys(ad_perfil)
    time.sleep(0.5)
    ...
    time.sleep(1)
    navegador.find_element(By.ID, 'Usuario-NomeCompleto').send_keys(nome_ope)
    time.sleep(0.5)
    ...
    time.sleep(1)
    navegador.find_element(By.ID, 'Usuario-Email').send_keys(email_ope)
    time.sleep(1)
    navegador.find_element(By.ID, 'Usuario-Login').send_keys(ad_perfil)
    time.sleep(0.5)
    ...
    time.sleep(0.5)
    navegador.find_element(By.ID, 'ZLoginPassword').send_keys('Gsx750fRf900rGs500e@2')
    time.sleep(0.5)
    ...
    #Criar
    navegador.find_element(By.ID, 'zdlgv__NEW_ACCT_name_2').send_keys(ad_perfil)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'zdlgv__NEW_ACCT_givenName').send_keys(n_ope)
    time.sleep(0.5)
    navegador.find_element(By.ID, 'zdlgv__NEW_ACCT_sn').send_keys(s_ope)
    time.sleep(0.5)
